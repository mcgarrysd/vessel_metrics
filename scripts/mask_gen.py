...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 11:19:33 2020
...
source_folder = '/home/sean/Documents/Calgary_postdoc/Data/czi_projections/Channel0/labels/'
json_path = "labels_vessel_annotation_test.json"    # Relative to root directory
count = 0                                           # Count of total images saved
file_bbs = {}                                       # Dictionary containing polygon coordinates for mask
MASK_WIDTH = 605									# Dimensions should match those of ground truth image
MASK_HEIGHT = 700									

# Read JSON file
with open(source_folder + json_path) as f:
  data = json.load(f)
